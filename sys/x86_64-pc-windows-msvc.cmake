...
if(NOT CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
  ...
  if(NOT ACE_NO_MOUNT AND NOT EXISTS ${ACE_TARGET_ROOT}/crt AND EXISTS ${ACE_TARGET_ROOT}.img)
    execute_process(COMMAND id -u OUTPUT_VARIABLE ACE_UID)
    execute_process(COMMAND id -g OUTPUT_VARIABLE ACE_GID)
    string(STRIP "${ACE_UID}" ACE_UID)
    string(STRIP "${ACE_GID}" ACE_GID)
    execute_process(COMMAND sudo mount -t vfat
      -o umask=0022,uid=${ACE_UID},gid=${ACE_GID}
      ${ACE_TARGET_ROOT}.img ${ACE_TARGET_ROOT}
      WORKING_DIRECTORY ${ACE})
  endif()
endif()
...
set(CMAKE_C_FLAGS_DEBUG "-O0 -g -Xclang -gcodeview" CACHE STRING "")
...
set(CMAKE_C_FLAGS_RELWITHDEBINFO "-O2 -g -Xclang -gcodeview -DNDEBUG ${CFLAGS_LTO}" CACHE STRING "")
set(CMAKE_C_FLAGS_COVERAGE "-O0 -g -Xclang -gcodeview -fprofile-instr-generate -fcoverage-mapping" CACHE STRING "")

set(CMAKE_CXX_FLAGS_INIT "${CFLAGS}")
set(CMAKE_CXX_FLAGS_DEBUG "-O0 -g -Xclang -gcodeview" CACHE STRING "")
...
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O2 -g -Xclang -gcodeview -DNDEBUG ${CFLAGS_LTO}" CACHE STRING "")
set(CMAKE_CXX_FLAGS_COVERAGE "-O0 -g -Xclang -gcodeview -fprofile-instr-generate -fcoverage-mapping" CACHE STRING "")
...
# Linker Flags
set(LDFLAGS "-L${ACE_TARGET_ROOT}/crt/lib")
set(LDFLAGS "${LDFLAGS} -L${ACE_TARGET_ROOT}/sdk/lib/ucrt")
set(LDFLAGS "${LDFLAGS} -L${ACE_TARGET_ROOT}/sdk/lib/um")

if(NOT CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
  set(LDFLAGS "${LDFLAGS} -Xlinker /MANIFEST:NO")
endif()

foreach(LINKER SHARED MODULE EXE)
  set(CMAKE_${LINKER}_LINKER_FLAGS_INIT "${LDFLAGS}")
  set(CMAKE_${LINKER}_LINKER_FLAGS_DEBUG "-Xlinker /DEBUG -Xlinker /INCREMENTAL" CACHE STRING "")
  set(CMAKE_${LINKER}_LINKER_FLAGS_RELEASE "-Xlinker /OPT:REF -Xlinker /OPT:ICF -Xlinker /INCREMENTAL:NO" CACHE STRING "")
  set(CMAKE_${LINKER}_LINKER_FLAGS_MINSIZEREL "-Xlinker /OPT:REF -Xlinker /OPT:ICF -Xlinker /INCREMENTAL:NO" CACHE STRING "")
  set(CMAKE_${LINKER}_LINKER_FLAGS_RELWITHDEBINFO "-Xlinker /DEBUG -Xlinker /INCREMENTAL" CACHE STRING "")
  set(CMAKE_${LINKER}_LINKER_FLAGS_COVERAGE "-Xlinker /DEBUG -Xlinker /INCREMENTAL" CACHE STRING "")
endforeach()
...
set(CMAKE_RC_FLAGS_INIT "-DWIN32")
if(NOT CMAKE_RC_COMPILER MATCHES "llvm-rc")
  set(CMAKE_RC_FLAGS_INIT "-nologo ${CMAKE_RC_FLAGS_INIT}")
endif()
