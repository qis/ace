...
# Cache & Time
if(CLANG_ENABLE_CCACHE)
  find_program(CLANG_CCACHE ccache REQUIRED NO_CACHE)
  set(CMAKE_C_COMPILER_LAUNCHER ${CLANG_CCACHE} CACHE PATH "")
  set(CMAKE_CXX_COMPILER_LAUNCHER ${CLANG_CCACHE} CACHE PATH "")
elseif(CLANG_ENABLE_TIME)
  find_program(CLANG_TIME time REQUIRED NO_CACHE)
  set(CMAKE_C_COMPILER_LAUNCHER "${CLANG_TIME};-f;%e" CACHE STRING "")
  set(CMAKE_CXX_COMPILER_LAUNCHER "${CLANG_TIME};-f;%e" CACHE STRING "")
endif()
