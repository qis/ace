...
if(VCPKG_TARGET_SYSROOT STREQUAL "linux")
  ...
  set(VCPKG_COMPILER_TARGET x86_64-pc-linux-gnu)
elseif(VCPKG_TARGET_SYSROOT STREQUAL "mingw")
  ...
  set(VCPKG_COMPILER_TARGET x86_64-w64-mingw32)
endif()
...
set(CMAKE_SYSTEM_PROGRAM_PATH ${ACE}/bin ${VCPKG_SYSTEM_PROGRAM_PATH} CACHE PATH "")
...
if(CMAKE_CROSSCOMPILING)
  set(CMAKE_C_COMPILER_TARGET ${VCPKG_COMPILER_TARGET} CACHE STRING "")
  set(CMAKE_CXX_COMPILER_TARGET ${VCPKG_COMPILER_TARGET} CACHE STRING "")
  set(CMAKE_ASM_COMPILER_TARGET ${VCPKG_COMPILER_TARGET} CACHE STRING "")
  set(CMAKE_ASM_NASM_COMPILER_TARGET ${VCPKG_COMPILER_TARGET} CACHE STRING "")
endif()
...
# Linker Flags
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
  set(CMAKE_C_STANDARD_LIBRARIES "-l:libc++.a")
elseif(VCPKG_TARGET_SYSROOT STREQUAL "linux")
  set(CMAKE_C_STANDARD_LIBRARIES "-l:libc++.so")
elseif(VCPKG_TARGET_SYSROOT STREQUAL "mingw")
  set(CMAKE_C_STANDARD_LIBRARIES "-l:libc++.dll.a")
endif()
...
if(VCPKG_TARGET_SYSROOT STREQUAL "linux")
  set(CMAKE_BUILD_RPATH
    ...
    ${ACE}/lib/${VCPKG_COMPILER_TARGET} CACHE PATH "")
...
if(VCPKG_TARGET_SYSROOT STREQUAL "mingw")
  ...
  set(CMAKE_RC_FLAGS_INIT "-DWIN32 -I ${ACE}/sys/mingw/include")
endif()
...
set(ENV{LD_LIBRARY_PATH} "${ACE}/vcpkg/installed/${VCPKG_TARGET_TRIPLET}/lib:${ACE}/lib/${VCPKG_COMPILER_TARGET}")
