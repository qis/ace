// This is a random access iterator similar to boost::counting_iterator for use
// with parallel algorithms. It's probably not necessary to have random access
// or overflow checking. More testing needed, but useful as a snippet.
...
public:
  ...
  constexpr counting_iterator(value_type value) noexcept : value_(value), start_(value) {}
  ...
  friend constexpr auto operator<=>(
    const counting_iterator& lhs,
    const counting_iterator& rhs) noexcept = default;
