if(PROJECT_IS_TOP_LEVEL AND CMAKE_CXX_COMPILER_ID AND CMAKE_CXX_MODULE_STD AND NOT CMAKE_TRY_COMPILE)
  if(NOT TARGET "__CMAKE::CXX23")
    if(NOT TARGET "__cmake_cxx23")
      ...
      target_include_directories(__cmake_cxx23 PRIVATE
        "${CMAKE_CXX_STANDARD_LINK_DIRECTORIES}/../share/libc++/v1")
      target_sources(__cmake_cxx23 PUBLIC
        FILE_SET std TYPE CXX_MODULES
        BASE_DIRS "${CMAKE_CXX_STANDARD_LINK_DIRECTORIES}/../share/libc++/v1"
        FILES "${CMAKE_CXX_STANDARD_LINK_DIRECTORIES}/../share/libc++/v1/std.cppm"
              "${CMAKE_CXX_STANDARD_LINK_DIRECTORIES}/../share/libc++/v1/std.compat.cppm")
    endif()
