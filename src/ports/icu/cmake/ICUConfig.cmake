...
if(EXISTS ${ACE_TARGET_ROOT}/share/icu/icudtl.dat)
  set(ICU_DATA "${ACE_TARGET_ROOT}/share/icu/icudtl.dat" CACHE PATH "")
  message(VERBOSE "Found ICU data file: ${ICU_DATA}")
else()
  message(FATAL_ERROR "Missing ICU data file: ${ACE_TARGET_ROOT}/share/icu/icudtl.dat")
