if(PROJECT_IS_TOP_LEVEL AND CMAKE_CXX_COMPILER_ID AND CMAKE_CXX_MODULE_STD AND NOT CMAKE_TRY_COMPILE)
  if(NOT TARGET "__CMAKE::CXX23")
    if(NOT TARGET "__cmake_cxx23")
      ...
      target_include_directories(__cmake_cxx23 PRIVATE "${ACE_MODULES_DIR}")
      target_sources(__cmake_cxx23 PUBLIC
        FILE_SET std TYPE CXX_MODULES
        BASE_DIRS "${ACE_MODULES_DIR}"
        FILES "${ACE_MODULES_DIR}/std.cppm"
              "${ACE_MODULES_DIR}/std.compat.cppm")
    endif()
  ...
  if(NOT TARGET "__CMAKE::CXX26")
    if(NOT TARGET "__cmake_cxx26")
      ...
      target_include_directories(__cmake_cxx26 PRIVATE "${ACE_MODULES_DIR}")
